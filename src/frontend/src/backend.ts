...
export class Backend implements backendInterface {
    ...
    async addToWaitlist(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addToWaitlist(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getWaitlist(): Promise<Array<WaitlistEntry>> {
        if (this.processError) {
            try {
